        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sections.map((section) => {
            ...
            return (
              ...
              >
                {/* Lock Overlay */}
                <div className="absolute inset-0 bg-white/60 dark:bg-[#181d23]/60 rounded-2xl pointer-events-none backdrop-blur-[1px]" />
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-2">
                    <div className="text-2xl font-bold text-gray-900 dark:text-white blur-[1px] select-none">
                      {section.value}
                    </div>
                    <div className="text-sm text-gray-500 dark:text-gray-400 blur-[0.5px] select-none">
                      {section.subValue}
                    </div>
                  </div>
                  ...
                  {/* Hover Tooltip */}
                  {hovered === section.key && (
                    <div className="absolute left-1/2 -translate-x-1/2 top-full mt-3 w-72 bg-white dark:bg-[#232b36] text-gray-900 dark:text-gray-100 text-sm rounded-xl shadow-2xl p-4 z-50 border border-blue-200 dark:border-[#4FC3F7]">
