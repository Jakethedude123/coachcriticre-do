      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="bg-black border border-gray-700 rounded-2xl p-8 w-80 flex flex-col items-center shadow-xl">
          ...
          <ul className="text-gray-200 space-y-2 mb-8 w-full">
            ...
            <li>✔️ Up to 3 review codes</li>
            <li>✔️ One review per client</li>
            ...
            <li>❌ Eligible for monthly spotlight</li>
        ...
        <div className="bg-yellow-50 border-4 border-yellow-300 rounded-2xl p-8 w-80 flex flex-col items-center shadow-2xl">
          ...
          <ul className="text-gray-800 space-y-2 mb-8 w-full">
            ...
            <li>✔️ Unlimited codes for client verification</li>
            <li>✔️ One code per client</li>
            <li>✔️ Add banner image and branding</li>
            <li>✔️ Upload a personal coach intro video</li>
            <li>✔️ Pro tier badge on profile</li>
            <li>✔️ Accessible insights dashboard</li>
            <li>✔️ Eligible for coachcritic homepage and IG spotlight</li>
        ...
        {/* Pro Plan - 6 Months */}
        <div className="bg-yellow-50 border-4 border-yellow-300 rounded-2xl p-8 w-80 flex flex-col items-center shadow-2xl">
          <div className="text-4xl font-bold text-gray-900 mb-1">$108 <span className="text-base font-normal text-gray-500">/ 6 months</span></div>
        ...
        {/* Pro Plan - 12 Months */}
        <div className="bg-yellow-50 border-4 border-yellow-300 rounded-2xl p-8 w-80 flex flex-col items-center shadow-2xl">
          <div className="text-4xl font-bold text-gray-900 mb-1">$192 <span className="text-base font-normal text-gray-500">/ 12 months</span></div>
